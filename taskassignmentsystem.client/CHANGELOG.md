...
- Create Angular project with ng: `ng new taskassignmentsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`taskassignmentsystem.client.esproj`).
